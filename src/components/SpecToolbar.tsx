  ...
  return (
    <>
      <motion.div
        ...
        className="hidden sm:block sticky top-0 z-20 -mx-4 sm:-mx-8 px-4 sm:px-8 py-3 bg-white/80 backdrop-blur-xl border-b border-border/40"
      >
      ...
      <motion.div
        ...
        className="sm:hidden sticky bottom-0 z-20 -mx-4 px-4 py-3 bg-white/90 backdrop-blur-xl border-t border-border/40"
      >
        <div className="flex items-center gap-2">
          <div className="flex items-center gap-1.5 px-2 py-1 rounded-md bg-muted text-[10px] font-medium text-muted-foreground shrink-0">
            <Clock className="w-3 h-3" />
            v{version}
          </div>
          {hasChanges && (
            <span className="text-[10px] text-accent font-medium animate-pulse-soft">
              Unsaved
            </span>
          )}
          ...
          <button
            onClick={handleDownload}
            className="flex items-center gap-1.5 px-4 py-2.5 text-[12px] font-medium bg-accent text-white rounded-xl active:scale-[0.97] transition-transform"
          >
            <Download className="w-3.5 h-3.5" />
            Download .md
          </button>
