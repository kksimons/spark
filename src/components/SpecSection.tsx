...
export function SpecSection({ section, isStakeholder, onSave, writing }: SpecSectionProps) {
      ...
      >
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h2
              className={cn(
                "text-[13px] sm:text-[14px] font-bold tracking-[-0.02em] leading-tight",
            ...
            {isStakeholder && !isSkeleton && (
              <p className="text-[10px] text-accent/50 font-medium mt-0.5 tracking-wide">
